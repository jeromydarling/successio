...
export const MODELS = {
  extraction:    "anthropic/claude-sonnet-4-5",   // primary extraction
  extraction_fb: "google/gemini-2.5-flash",        // extraction fallback
  ocr_heavy:     "mistral/mistral-ocr-latest",     // scanned docs
  ocr_light:     "google/gemini-2.5-flash",        // handwriting / complex forms
  embeddings:    "@cf/baai/bge-base-en-v1.5",      // Workers AI native
  transcription: "@cf/openai/whisper",              // Workers AI native
  profile_draft: "anthropic/claude-opus-4-5",      // CIM narrative drafting
} as const;
...
export class AIGateway {
  ...
  /** Call a chat-completion model via the gateway. */
